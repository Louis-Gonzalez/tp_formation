    ...
    <section id="products-table" class="container">
        ...
        <table class="table">
            ...
            <tbody class="table-group-divider">
                ...
                :key ="index"><!-- v-for bouble sur le tableau products qui est une props de l'export default, "item" est l'élement à l'intérieur du tableau 
                    et index est l'itérateur pour parcourrir le tableau --> <!-- :key = "index" est le point de départ de l'itération-->
                    <td>{{ item.id }}</td>
                    <td>{{ item.name }}</td>
                    <td>{{ item.category }}</td>
                    <td>
