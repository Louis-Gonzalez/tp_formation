...
if ($db){
    $sql = $db->query("SELECT * FROM post WHERE title LIKE '%".$keywords."%' or description LIKE '%".$keywords."%' ORDER BY id DESC");  // requete sql pour recupérer les data de la table post // query peut être remplacer par prepare
